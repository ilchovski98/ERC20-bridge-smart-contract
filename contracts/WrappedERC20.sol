...
contract WrappedERC20 is ERC20PresetMinterPauser {
  ...
  constructor(string memory _name, string memory _symbol, address owner) ERC20PresetMinterPauser(_name, _symbol) {
